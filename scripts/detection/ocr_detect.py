...
if __name__ == '__main__':
    ...
    # Try to load best model from standardized location
    ...
    if model_path is None:
        raise FileNotFoundError(
            "Could not find YOLO weights. Run grid search analysis first or check paths.\n"
            + "Checked: " + ", ".join(str(p) for p in candidate_model_paths)
        )
